...
export const projects: Project[] = [
  ...
  },
  {
    ...
    teaser:
      "Eine schlanke Portfolio-Site für mein Musikprojekt – gebaut mit Nuxt 4 und Tailwind.",
    cover: "/images/aaronthommy-project.png",
    category: "website",
    technologies: ["Nuxt", "Vue 3", "Tailwind CSS", "TypeScript", "Figma"],
    year: "2024",
    client: "Eigenprojekt",
    description:
      "Eine moderne, performante Portfolio-Website für mein Musikprojekt mit fokus auf User Experience und schnelle Ladezeiten.",
    features: [
  ...
  {
    slug: "nadel-und-pinsel",
    title: "Nadel und Pinsel",
    teaser:
      "Eine schlanke Portfolio-Site für mein Kunstprojekt – gebaut mit Nuxt 4 und Tailwind.",
    cover: "/images/nadel-und-pinsel-project.png",
    category: "website",
    technologies: ["Nuxt", "Vue 3", "Tailwind CSS", "TypeScript", "Figma"],
    year: "2025",
    client: "Eigenprojekt",
