...
const navigation = {
  ...
  social: [
    {
      name: "GitHub",
      href: "https://github.com/aaronweber",
      icon: (
    ...
    {
      name: "LinkedIn",
      href: "https://linkedin.com/in/aaronweber",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Xing",
      href: "https://xing.com/profile/aaron_weber",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-50 border-t border-slate-200/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <p className="text-slate-600 leading-relaxed max-w-sm">
              Professionelle Websites, innovative Webshops und maßgeschneiderte Software-Lösungen für Ihren digitalen Erfolg.
            </p>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center space-x-3 text-slate-600">
                ...
                <span>Hildesheim, Deutschland</span>
              </div>
              <div className="flex items-center space-x-3 text-slate-600">
                <svg className="w-5 h-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>kontakt@aaron-weber.de</span>
              </div>
            </div>
          </div>
          ...
          {/* Services */}
          <div className="space-y-6">
            <h3 className="text-lg font-semibold text-slate-900">Leistungen</h3>
            <ul className="space-y-3">
          ...
          {/* Legal & Social */}
          <div className="space-y-6">
            <h3 className="text-lg font-semibold text-slate-900">Rechtliches</h3>
            <ul className="space-y-3">
            ...
            {/* Social Links */}
            <div className="pt-4">
              <h4 className="text-sm font-medium text-slate-900 mb-4">Folgen Sie mir</h4>
              <div className="flex space-x-4">
                {navigation.social.map((item) => (
                  <Link
                    ...
                    className="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-slate-400 hover:text-blue-600 hover:shadow-lg transition-all duration-300 border border-slate-200/50"
      ...
      {/* Newsletter Section */}
      <div className="border-t border-slate-200/50 bg-white/50">
        <div className="container mx-auto px-6 py-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-slate-600 mb-8 max-w-2xl mx-auto">
              Erhalten Sie Updates zu neuen Projekten, Technologie-Trends und exklusive Einblicke in die Webentwicklung.
            </p>
            ...
            <form className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none transition-all duration-300"
                required
              />
              <button
                type="submit"
      ...
      {/* Bottom Bar */}
      <div className="border-t border-slate-200/50 bg-slate-100/50">
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-sm text-slate-600">
              © {currentYear} Aaron Weber. Alle Rechte vorbehalten.
            </div>
