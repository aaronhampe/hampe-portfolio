...
export default function ReactCrmPage() {
  const project = projects.find(p => p.slug === "react-crm");
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-100 dark:bg-purple-900/30 rounded-full text-purple-700 dark:text-purple-300 text-sm font-medium">
                  <Icon icon="ph:code-duotone" className="w-4 h-4" />
                  <span>Software</span>
                </div>
            ...
            <div className="relative">
              ...
              {/* Floating decoration */}
              <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-gradient-to-br from-purple-600 to-blue-600 rounded-3xl opacity-10 dark:opacity-20"></div>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-4xl md:text-5xl font-thin text-slate-900 dark:text-white mb-6">
                  Key <span className="font-light text-purple-600">Features</span>
                </h2>
                <p className="text-xl text-slate-600 dark:text-slate-300">
                  Was dieses CRM-System besonders macht
                </p>
              </div>
                ...
                {project.features.map((feature, index) => (
                  ...
                  >
                    <div className="w-8 h-8 bg-purple-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center flex-shrink-0 mt-1">
                      <Icon icon="ph:check-bold" className="w-5 h-5 text-purple-600 dark:text-purple-400" />
                    </div>
                    <div>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-slate-600 dark:text-slate-300 mb-16">
                Die messbaren Erfolge dieses CRM-Systems
              </p>
      ...
      <section className="py-24 bg-white dark:bg-slate-950">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-thin text-slate-900 dark:text-white mb-6">
                Technische <span className="font-light text-blue-600">Umsetzung</span>
              </h2>
              <p className="text-xl text-slate-600 dark:text-slate-300">
                Ein Blick unter die Haube der CRM-Lösung
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="p-8 bg-slate-50 dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800">
                <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900/30 rounded-2xl flex items-center justify-center mx-auto mb-6">
                  <Icon icon="ph:browser-bold" className="w-8 h-8 text-blue-600 dark:text-blue-400" />
                </div>
                ...
                <p className="text-slate-600 dark:text-slate-300 text-center mb-4">
                  Moderne React-Architektur mit Next.js 15 für optimale Performance
                </p>
                <ul className="text-sm text-slate-500 dark:text-slate-400 space-y-2">
                  <li>• Server Components</li>
                  <li>• TypeScript für Typsicherheit</li>
                  <li>• Tailwind CSS für Design</li>
                </ul>
              </div>

              <div className="p-8 bg-slate-50 dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800">
                <div className="w-16 h-16 bg-green-100 dark:bg-green-900/30 rounded-2xl flex items-center justify-center mx-auto mb-6">
                  <Icon icon="ph:database-bold" className="w-8 h-8 text-green-600 dark:text-green-400" />
                </div>
                <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-4 text-center">
                  Backend
                </h3>
                <p className="text-slate-600 dark:text-slate-300 text-center mb-4">
                  Robuste API-Struktur mit Prisma ORM und PlanetScale
                </p>
                <ul className="text-sm text-slate-500 dark:text-slate-400 space-y-2">
                  <li>• Prisma für Datenbankzugriff</li>
              ...
              <div className="p-8 bg-slate-50 dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800">
                <div className="w-16 h-16 bg-purple-100 dark:bg-purple-900/30 rounded-2xl flex items-center justify-center mx-auto mb-6">
                  <Icon icon="ph:shield-check-bold" className="w-8 h-8 text-purple-600 dark:text-purple-400" />
                </div>
                <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-4 text-center">
                  Authentifizierung
                </h3>
                <p className="text-slate-600 dark:text-slate-300 text-center mb-4">
                  Sichere Benutzerauthentifizierung mit NextAuth.js
                </p>
                <ul className="text-sm text-slate-500 dark:text-slate-400 space-y-2">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <p className="text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed">
              Lassen Sie uns gemeinsam eine maßgeschneiderte CRM-Lösung für Ihr Unternehmen entwickeln.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center pt-8">
              ...
              >
                <span className="relative z-10">CRM-Lösung besprechen</span>
