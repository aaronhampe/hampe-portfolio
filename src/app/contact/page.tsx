      ...
      <main className="min-h-screen bg-gradient-to-br from-slate-50 to-white flex items-center justify-center px-6">
        <div className="max-w-2xl mx-auto text-center space-y-8">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 w-24 h-24 bg-green-500 rounded-full mx-auto opacity-20 animate-ping"></div>
          </div>

          <div className="space-y-4">
            <h1 className="text-4xl md:text-5xl font-thin text-slate-900">
              Nachricht
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
            <Link
              href="/"
              className="px-8 py-4 bg-slate-900 text-white rounded-2xl font-medium text-lg hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
            >
              Zur Startseite
            </Link>
            <Link
              href="/projects"
              className="px-8 py-4 border-2 border-slate-200 text-slate-900 rounded-2xl font-medium text-lg hover:border-slate-300 hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
            >
              Projekte ansehen
            </Link>
          </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg border border-slate-100">
              <div className="mb-8">
                <h2 className="text-3xl font-light text-slate-900 mb-4">Projekt anfragen</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none transition-all duration-300 disabled:bg-slate-50 disabled:opacity-50"
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    required
                    disabled={formState === 'loading'}
                    className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none transition-all duration-300 resize-none disabled:bg-slate-50 disabled:opacity-50"
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-3xl p-8 border border-blue-100">
                <h3 className="text-2xl font-light text-slate-900 mb-4">Schnelle Antwortzeiten</h3>
